...
public class ContactsDemo implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		// Start NorthActivityManager for the north widget with the NorthActivityMapper
		...
		// Start CenterActivityManager for the center widget with the CenterActivityMapper
